...
if data_sr.set_theme() == 'dark':
    from MODULE import dark_theme_ui
    ...
    class Ui_MainWindow(object):
        def setupUi(self, MainWindow):
            ...
            self.main_page.setGeometry(QtCore.QRect(-2, -3, 801, 601))
            font = QtGui.QFont()
            ...
            self.text_neuro.setStyleSheet("color: rgb(0, 0, 0);\n"
                                          "border-radius: 10;\n"
            ...
            self.neuro_swith_box.setStyleSheet("")
            ...
            self.console_lable.setGeometry(QtCore.QRect(-1, 528, 806, 52))
            font = QtGui.QFont()
            ...
            self.console_lable.setStyleSheet("background-color: rgb(221, 221, 221);")
            ...
            self.settings_lable.setStyleSheet("")
            self.settings_lable.setObjectName("settings_lable")
            self.lenght = QtWidgets.QLabel(self.settings)
            self.lenght.setGeometry(QtCore.QRect(252, 43, 61, 31))
            font = QtGui.QFont()
            font.setFamily("Malgun Gothic Semilight")
            font.setPointSize(13)
            font.setBold(True)
            ...
            self.reload_lable.setStyleSheet("")
            ...
            self.train_epoch_lable.setStyleSheet("")
            ...
            self.chose_theme_box.setStyleSheet("")
        ...
        def add_function(self):
            self.generate_btn.clicked.connect(lambda: self.generate_text())
            self.delete_btn.clicked.connect(lambda: self.delete_text())
            self.apply_btn.clicked.connect(
                lambda: self.save_data(lenght=self.lenghtBox.value(), train_epoch=self.epochBox.value(),
                                       theme='light' if self.chose_theme_box.currentText() == 'White theme' else 'dark'))
        ...
        def retranslateUi(self, MainWindow):
            ...
            self.console_lable.setText(_translate("MainWindow", "Если программа зависла - это нормально, после окончания обучения она восстановится"))
            ...
            self.lenght.setText(_translate("MainWindow", "length"))
            self.apply_btn.setText(_translate("MainWindow", "APPLY"))
            self.train_epoch_lable.setText(_translate("MainWindow", "train epoch"))
            self.chose_theme_box.setItemText(0, _translate("MainWindow", "White theme"))
            self.chose_theme_box.setItemText(1, _translate("MainWindow", "Dark theme"))
